...
void EnQueue(LinkQueue& Q, windows e)
{
...
void Swap(QueueNode*& a, LinkQueue& Q)
{
...
int Find(LinkQueue Q, int x1, int y1)
{
    ...
    while (p != NULL)
    {
        if ((x1 >= p->data.x1) && (x1 <= p->data.x2) && (y1 >= p->data.x1) && (y1 <= p->data.x2))
        {
            word = p->data.serial;
            break;
        }
